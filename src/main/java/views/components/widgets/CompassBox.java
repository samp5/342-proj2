...
/**
 * A {@code SmallBox} used for displaying information about the current wind
 * speed and direction.
 * The graphic and data has a 16-point compass resolution, with an included
...
public class CompassBox extends SmallBox {
  ...
  protected void assembleSVG() {
    ...
    markRegion = newSVG(
        "M 0 5 A 1 1 0 0 0 10 5 A 1 1 0 0 0 0 5 M 5 1 l 0 1 M 1 5 l 1 0 M 9 5 l -1 0 M 5 9 l 0 -1 M 7.12132 7.12132 L 7.82843 7.82843 M 2.87868 2.87868 L 2.17157 2.17157 M 2.17157 7.82843 L 2.87868 7.12132 M 7.12132 2.87868 L 7.82843 2.17157 M 7.77164 6.14805 L 8.69552 6.53073 M 2.22836 3.85195 L 1.30448 3.46927 M 2.22836 3.85195 L 1.30448 3.46927 M 2.22836 6.14805 L 1.30448 6.53073 M 7.77164 3.85195 L 8.69552 3.46927 M 6.53073 8.69552 L 6.14805 7.77164 M 3.46927 1.30448 L 3.85195 2.22836 M 3.46927 8.69552 L 3.85195 7.77164 M 6.53073 1.30448 L 6.14805 2.22836");
  ...
  /**
   * get the 16-point compass direction abbreviation based on the current wind
   * direction
   *
